...
class _FormStep2ScreenState extends State<FormStep2Screen> {
  ...
  // Mock slots - in real app these would come from API
  static const _slots = [
              ...
              child: ElevatedButton(
                onPressed: _selectedSlotId == null
                    ...
                    : () {
                        ...
                        appState.updateBooking(appState.booking.copyWith(slot: slot));
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const FormStep3Screen()),
                        );
                      },
